...
- 자바스크립트는 **인터프리터 언어**
  ...
  → 브라우저 내에서 실행되는 시점에 자바스크립트 코드가 어떻게 해석되고 있는지 BreakPoint를 걸어서 멈춰놓고 그 안의 변수값들을 확인해볼 수 있음

## DOM BreakPoint (Dom Node 관련)🛠
...
- BreakPoint에서 현재 Scope에 해당하는 모든 변수들을 확인 가능
  - Local
  - Closure : 상위의 부모가 가진 변수
  - Global

## Watch
- BreakPoint 타이밍에 어떤 값을 모니터링하고 싶을 때 사용
